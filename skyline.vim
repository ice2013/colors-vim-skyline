...
"hi Normal          guifg=#ecf0f1 guibg=#34495e
hi Folded          guifg=#666666 guibg=bg
"hi CursorLine                    guibg=#2c3e50  "#232728
"hi CursorColumn                  guibg=#2c3e50  "#232728
"hi ColorColumn                   guibg=#2c3e50  "#232728
...
hi MatchParen      guibg=#f39800 guifg=#232728 gui=bold
...
" }}}
" Cursor {{{
" F35FBC now is 0A9DFF
hi Cursor          guifg=#000000 guibg=#0A9DFF
...
" Completion Menu {{{
" 0A9DFF was 6699FF was AAF412
hi Pmenu           guifg=#cccccc guibg=#232728
" hi PmenuSel        guifg=#000000 guibg=#0A9DFF  gui=bold
hi PmenuSel        guifg=#000000 guibg=#0A9DFF
...
" Spelling {{{
if has("spell")
    hi SpellBad   guifg=NONE guibg=bg guisp=#FF0000 gui=undercurl
    hi SpellCap   guifg=NONE guibg=bg guisp=#7070F0 gui=undercurl
    hi SpellLocal guifg=NONE guibg=NONE  guisp=#70F0F0 gui=undercurl
    hi SpellRare   guifg=NONE guibg=NONE guisp=#FFFFFF gui=undercurl
endif
" }}}
" Visual Mode {{{
